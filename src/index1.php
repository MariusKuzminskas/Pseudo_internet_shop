...
<body>
    ...
    <div class="top-logo-container d-flex justify-content-center">
        <img class="" src="./img/logo-150.png" alt="logotipas">
    </div>
    ...
    <!-- NAV SECTION END  ******************************************** -->
    <!-- <div class="line-div mx-auto w-50"></div> -->

    <section  class="container main1-container">
        <div class="row mt-3">
